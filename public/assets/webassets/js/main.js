(function ($) {
	...
	/*=============================================
		=         category-show-script-here       =
	=============================================*/
	$('.ucm-active-categoryshow').owlCarousel({
		loop: true,
		margin: 20,
		items: 4,
		autoplay: true,
	...
	$('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
		$(".ucm-active-categoryshow").trigger('refresh.owl.carousel');
	});
...
// mobile active Scripts 
// const menuLinks = document.querySelectorAll(".bfc-content-menu-link");
...
const mobile_active_iconbfc = document.querySelectorAll(".mobile_active_iconbfc");
mobile_active_iconbfc.forEach((link) => {
	link.addEventListener("click", () => {
		mobile_active_iconbfc.forEach((link) => {
			link.classList.remove("bfcbg-active");
		});
		link.classList.add("bfcbg-active");
	});
});